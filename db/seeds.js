...
User
  .create([
    ...
    },
    {
      ...
      profilePic: '/images/jasmine.png',
      role: 'user'
    },
    {
      fullName: 'Molly',
      username: 'mollylondon',
      ...
      personality: [ 'Party animal', 'Comfort food fan', 'Trendsetter'],
      profilePic: '/images/molly.png',
      role: 'user'
    },
    {
      fullName: 'Lisa',
      username: 'lisasalford',
      email: 'lisa@platyp.com',
      password: 'l',
      ...
      personality: [ 'Family trip planner', 'Peace and quiet seeker', 'Comfort food fan'],
      profilePic: '/images/lisa.png',
      role: 'user'
    },
    {
      fullName: 'Pauline',
      username: 'paulinerichmond',
      email: 'pauline@platyp.com',
      password: 'p',
      ...
      personality: [ 'Peace and quiet seeker', 'Fine dining fan', 'Health conscious'],
      profilePic: '/images/pauline.png',
      role: 'user'
    },
    {
      fullName: 'Sam',
      username: 'sammanchester',
      ...
      personality: [ 'Spicy food lover', 'Adventurous eater', 'Will eat anything and everything' ],
    ...
    },
    {
      ...
      personality: [ 'Vegetarian/vegan', 'Health conscious', 'Peace and quiet seeker' ],
      profilePic: '/images/ben.png',
      role: 'user'
    },
    {
      fullName: 'Peter',
      username: 'peterlondon',
      email: 'peter@platyp.com',
      password: 'p',
      passwordConfirmation: 'p',
      type: 'reviewer',
      city: 'London',
    ...
    {
      fullName: 'Brian',
      username: 'brianaltrincham',
      email: 'brian@platyp.com',
      password: 'b',
      passwordConfirmation: 'b',
      type: 'reviewer',
      city: 'Altrincham',
      ...
      personality: [ 'Party animal', 'Adventurous eater', 'Will eat anything and everything' ],
      profilePic: '/images/brian.png',
      role: 'user'
    }
  ])
